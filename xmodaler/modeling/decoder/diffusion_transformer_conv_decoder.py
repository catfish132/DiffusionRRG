...
from ..layers.bert import BertGenerationLayer, BertGenerationRmLayer, BertConvGenerationLayer
__all__ = ["DiffusionTransformerConvDecoder"]


@DECODER_REGISTRY.register()
class DiffusionTransformerConvDecoder(TransformerDecoder):
    @configurable
    def __init__(
            self,
            *,
        ...
        super(DiffusionTransformerConvDecoder, self).__init__(
    ...
    def from_config(cls, cfg):
        bert_generation_layers = nn.ModuleList(
            [BertConvGenerationLayer(cfg) for _ in range(cfg.MODEL.BERT.NUM_GENERATION_LAYERS)]
        )
        return {
